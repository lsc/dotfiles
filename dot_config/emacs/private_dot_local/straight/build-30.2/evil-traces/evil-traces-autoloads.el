;;; evil-traces-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
`Evil-Traces mode' mode.  If the prefix argument is positive, enable the
