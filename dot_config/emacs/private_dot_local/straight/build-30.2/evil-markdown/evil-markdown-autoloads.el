;;; evil-markdown-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
`Evil-Markdown mode' mode.  If the prefix argument is positive, enable
...
evaluate the variable `evil-markdown-mode'.
