...
mpdw.font = "Inonsolata"
mpdw.scrolling = true
mpdw.output_size = 50
mpdw.update_interval = 10
mpdw.path_to_icons = "/home/lsc/.config/awesome/icons"

mpdw.servers = {
	{ server = "10.0.0.3", port = 6600},
	{ server = "localhost", port = 6600 },
}

mpdw:register_buttons({
			{ "", awesompd.MOUSE_LEFT, mpdw:command_toggle() },
			{ "", awesompd.MOUSE_SCROLL_UP, mpdw:command_volume_up()},
			{ "", awesompd.MOUSE_SCROLL_DOWN, mpdw:command_volume_down()},
